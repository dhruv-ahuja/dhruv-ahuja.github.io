...
I picked up FastAPI instead of Django, because I saw [this talk](https://youtu.be/37CcB2GBdlY) by FastAPI founder [Sebastián](https://github.com/tiangolo), and thought that async-first and type safety in web apps sounded great and was the future, even though I barely knew what Python types were at the time.
